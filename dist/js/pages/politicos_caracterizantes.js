for (var i in politicos) {
    ...
    $('#comboPart').append("<option id='" + i + "'>"+politico+"</option>");
}

function comboPoliticos(){
    var politicoId = document.getElementById("comboPart").selectedIndex;
    createTags(politicoId, "#visCaracterizante");
...
function createTags(politicoId, div){
    ...
    for (var palavraId in palavras){
        ...
        var importancia = Number(model[politicoId][palavraId]);
